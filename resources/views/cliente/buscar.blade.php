...
<form action="{{route('guardar')}}" method="POST">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-12">
            <h2>Seleccionar Sala de Repocision</h2>
        </div>
    </div>
    <br>
    <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <br>
                <div class="col-lg-2">
                    <div class="form-group" id="data_1">
                        <label class="font-normal">Seleccione la fecha</label>
                        <div class="input-group date">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="fecha" class="form-control" value="{{date('m/d/Y')}}">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" required="" name="idDireccion" value="{{$item->id_direccion}}"></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
